...
links:
  - href: https://www.instagram.com/contradasangiorgiodesio
    icon: fab fa-instagram
    title: Instagram
    description: Pagina Instagram ufficiale
  - href: https://www.facebook.com/share/1EEG17Luki/
    icon: fab fa-facebook
    title: Facebook
    description: Pagina Facebook ufficiale
  - href: https://linktr.ee/contrada_sangiorgio_desio
    icon: fas fa-sharp fa-regular fa-tree
    title: LinkTree
    description: Pagina LinkTree
  - href: https://github.com/contradasangiorgio
    icon: fab fa-github
    title: GitHub
...
#spotifyPlaylist:
#  iframe: <iframe style="border-radius:12px"
#    src="https://open.spotify.com/embed/playlist/6zcsSLDrLiCpX8KDzNiIhS?utm_source=generator"
...
#    - icon: fas fa-check-circle
#      color: text-green-400
#      text: For collaboration requests, include details about the project scope and
#        timeline.
#    - icon: fas fa-check-circle
#      color: text-green-400
